...
return apply_filters( 'wc_paylike_settings',
	array(
		...
		'advanced_section_script'       => array(
			'type'        => 'script',
			'description' => 'This is how we create a new field to add javscript that allows toggling the advanced section on and off',
		),
		'advanced'                      => array(
		...
		'surcharge_percentage'          => array(
			'title'       => __( 'Percentage surcharge', 'woocommerce-gateway-paylike' ),
			'type'        => 'decimal',
			'description' => __( 'You can add a percentage fee (based on the cart total) for users paying with this payment gateway. (0-100, 0 disables it)', 'woocommerce-gateway-paylike' ),
			'default'     => 0,
			'desc_tip'    => true,
		),
		'surcharge_fee'                 => array(
			'title'       => __( 'Percentage fee', 'woocommerce-gateway-paylike' ),
			'type'        => 'decimal',
			'description' => __( 'You can add a flat fee for users paying with this payment gateway. (0 disables it)', 'woocommerce-gateway-paylike' ),
			'default'     => 0,
			'desc_tip'    => true,
		),
		'surcharge_fee_name'            => array(
			'title'       => __( 'Flat fee name', 'woocommerce-gateway-paylike' ),
			'type'        => 'text',
			'description' => __( 'You can add a flat fee for users paying with this payment gateway. (0 disables it)', 'woocommerce-gateway-paylike' ),
			'default'     => 'Credit card flat fee',
			'desc_tip'    => true,
		),
		'surcharge_percentage_fee_name' => array(
			'title'       => __( 'Percentage fee name', 'woocommerce-gateway-paylike' ),
			'type'        => 'text',
			'description' => __( 'You can add a flat fee for users paying with this payment gateway. (0 disables it)', 'woocommerce-gateway-paylike' ),
			'default'     => 'Credit card percentage fee',
			'desc_tip'    => true,
		),
